...
| Record exact attack prompts and observed responses | DONE | Current [offline case files](../visitprep_eval/reports/offline-siva/cases/) and [actual Nebius case files](../visitprep_eval/reports/siva-live/cases/). Preserve request-level consent, response and source IDs. |
