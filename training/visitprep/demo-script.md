...
| 55–75 seconds | The current PI-01 hostile note, actual model response and final cited evidence. | “This imported note tries to change the assistant's job. The recorded experiment lets us inspect what the model returned and what the application allowed.” |
